...
import numpy as np
from src.data.dataset.coco_dataset import mscoco_category2name, mscoco_category2label, mscoco_label2category
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--resume', type=str,  default='../../pretrained_checkpoints/rtdetrv2_r18vd_120e_coco_rerun_48.1.pth')
